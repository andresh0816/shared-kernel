...
namespace SharedKernel.Integration.Tests.Cqrs.Commands
{
    public class InMemoryCommandBusTests : InfrastructureTestCase
    {
        ...
        public async Task TestCommandHandlerWithResponse()
        {
            ...
            var response = await GetRequiredService<ISender>().SendAsync(request, CancellationToken.None);
        ...
        public void TestCommandValidatorEmpty()
        {
            ...
            Func<Task> response = async () => await GetRequiredService<ISender>().SendAsync(request, CancellationToken.None);
        ...
        public async Task DispatchInQueueSumTime()
        {
            ...
            var commandBus = GetRequiredService<ISender>();
